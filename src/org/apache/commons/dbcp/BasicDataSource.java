 ...
 * 修改createDataSource方法，增加对sybase和os400驱动的特殊属性
 * @author luojun
 */
public class BasicDataSource implements DataSource {
    ...
    protected synchronized DataSource createDataSource()
		...
		if (driverClassName.startsWith("com.sybase.jdbc2.jdbc"))
		{
			connectionProperties.put("charset", "cp936");
		}
		if (driverClassName.equals("com.ibm.as400.access.AS400JDBCDriver"))
		{
			connectionProperties.put("date format","iso");
		}
		/*
        System.out.println("===========================================");
        System.out.println("driverClassName=" + driverClassName + "," + connectionProperties);
        System.out.println("===========================================");
        */
